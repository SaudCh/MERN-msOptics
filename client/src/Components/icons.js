...
import { faArrowRightFromBracket, faCartShopping, faChevronLeft, faChevronRight, faEarthAsia, faSearch, faUser, faPlus, faMinus, faCircleXmark, faTrash, faHeart } from '@fortawesome/free-solid-svg-icons';
...
export const LogoutIcon = ({ color, size, style }) => (
    <FontAwesomeIcon icon={faArrowRightFromBracket} color={color} size={size} style={style} />
);
...
export const CircleXMarkIcon = ({ color, size, style }) => (
    <FontAwesomeIcon icon={faCircleXmark} color={color} size={size} style={style} />
);
