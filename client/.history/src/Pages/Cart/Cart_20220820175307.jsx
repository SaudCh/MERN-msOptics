...
export default function Cart() {
  ...
  return (
    <section className="container-fluid mt-3 pt-2">
      <div className="row justify-content-center flex-column-reverse flex-row">
        <div
          className="col-11 col-md-9 bg-light border rounded p-2"
